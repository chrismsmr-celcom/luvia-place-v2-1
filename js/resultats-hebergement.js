...
(function() {
    ...
    function renderHotels(hotels) {
        ...
        if (count) count.textContent = total + ' propriétés dans ' + cityName;
        container.innerHTML = '';
        ...
        hotels.forEach(function(hotel) {
            ...
            if (hotel.minPrice > 0) {
                ...
                priceBlock.innerHTML =
                    ...
                    '<div class="note">' + nightsText + ', 1 chambre, taxes et frais inclus</div>' +
...
window.voirHotel = voirHotel;
    ...
    // ============================================
    // CHARGEMENT DES RÉSULTATS - STREAMING SSE
    // ============================================
    function loadResultsStream() {
        ...
        setTimeout(function() {
            if (!isLoadingComplete && eventSource) {
